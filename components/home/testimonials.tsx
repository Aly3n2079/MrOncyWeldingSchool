  ...
  return (
    <section className="py-16 bg-steel-blue text-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <h2 className="section-title text-center text-white mb-12 animate-fade-in">What Our Students Say</h2>

        <div className="relative max-w-4xl mx-auto">
          {/* Left scroll trigger area */}
          <div
            className="absolute left-0 top-1/2 bottom-0 w-16 z-20 flex items-center justify-start opacity-0 hover:opacity-100 transition-opacity h-1/2 -translate-y-1/2"
            ...
            >
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="w-full flex-none px-4">
                  <div className="bg-white/10 backdrop-blur-sm p-8 rounded-lg shadow-lg transition-all duration-500 hover:shadow-xl transform hover:scale-[1.02]">
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                      <div className="relative w-24 h-24 rounded-full overflow-hidden flex-shrink-0 border-2 border-welding-orange shadow-lg transition-transform duration-500 hover:scale-110">
                        <Image
                      ...
                      <div>
                        ...
                        <div>
                          ...
                          <p className="text-welding-orange">{testimonial.role}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div
            className="absolute right-0 top-1/2 bottom-0 w-16 z-20 flex items-center justify-end opacity-0 hover:opacity-100 transition-opacity h-1/2 -translate-y-1/2"
